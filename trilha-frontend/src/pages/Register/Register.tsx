  ...
  return (
    <div className="register-page">
      <main className="register-wrapper">
        <h1 className="register-page-title">Página de Cadastro</h1>
        <section className="register-card">
          <header className="register-header"><span>Trilha+</span></header>
          <form className="register-content" onSubmit={register}>
            ...
            <button className="register-login" type="button" onClick={() => navigate('/login')}>Login</button>
